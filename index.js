...
let lightColorLightless;
let darkColorLightless;
let whiteColorLightless;

// change background color 
const changeBG = () => {
  root.style.setProperty('--light-color-lightness', lightColorLightless)
  root.style.setProperty('--white-color-lightness', whiteColorLightless)
  root.style.setProperty('--dark-color-lightness', darkColorLightless)
}
...
Bg2.addEventListener("click", () => {
  lightColorLightless = "15%";
  darkColorLightless = "95%";
  whiteColorLightless = "20%";
